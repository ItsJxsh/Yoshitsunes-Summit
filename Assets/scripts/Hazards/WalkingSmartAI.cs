...
public class WalkingSmartAI : MonoBehaviour
{
    ...
    void Update()
    {
        bool isNearEdge = !Physics2D.Linecast(transform.position, ledgeDetector.position, groundLayer);
